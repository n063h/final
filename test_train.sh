...
# python train.py max_epochs=1 name=test_train dataset=nir dataset.axis=0 model=resnet1d model.name=3resnet1d arch=pi arch.name=pi5 label_ratio=0.01 notes=pi4_3r_works_cls10
...
# python train.py max_epochs=1 name=test_train dataset=nir model=resnet1d  model.name=3resnet1d arch=tri arch.name=tri5 label_ratio=0.01 notes=test_train_tri5_3r_works_cls10
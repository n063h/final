...
def get_multiclass_metrics_collections(num_classes):
...
def get_multiclass_acc_metrics(num_classes):
    return MetricCollection({'acc':Accuracy(task="multiclass", num_classes=num_classes)})
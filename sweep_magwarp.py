...
def sweep():
    ...
    conf.dataset.w_augs=build_augs(conf.dataset.w_augs,conf.alpha,int(conf.beta))
    conf.dataset.s_augs=build_augs(conf.dataset.s_augs,conf.alpha,int(conf.beta))
